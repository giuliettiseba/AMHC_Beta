...
$FilePath = "$Env:USERPROFILE\Data\MilestoneTB4.docx"
$WordDocument = Get-WordDocument $FilePath

### Define JSON file
$JPath = "$Env:USERPROFILE\Data\output.json"
...
$MilestoneMediaDeletionLow_List = $in.MediaDeletionDuetoLowDiskSpace.DeletionDuetoLowDiskSpaceErrorList
$MilestoneMediaDeletionOverflow_List = $in.MediaDeletionDuetoOverflow.MediaDeletionDuetoOverflowList
...
#$MSRAM_M = 16777216
$MSRAM_T = (([Int]$MSRAM_0+[Int]$MSRAM_1+[Int]$MSRAM_2+[Int]$MSRAM_3+[Int]$MSRAM_4)/5/[Int]$MSRAM_M)*100
...
$MSCPU_T = (([Int]$MSCPU_0+[Int]$MSCPU_1+[Int]$MSCPU_2+[Int]$MSCPU_3+[Int]$MSCPU_4)/5/[Int]$MSCPU_M)*100
...
$MilestoneHardwareAcceleration_wwc_text = "No available on this release"
$MilestoneHardwareAcceleration_Result_text = "No available on this release"
